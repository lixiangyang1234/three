...
- (void)initializePageControl {
    CGRect pageControlFrame = CGRectMake(0, 0, CGRectGetWidth(_scrollView.frame), 20);
    _pageControl = [[UIPageControl alloc] initWithFrame:pageControlFrame];
     _pageControl.frame=CGRectMake( _scrollView.frame.size.width/5*4, _scrollView.frame.size.height-20, _scrollView.frame.size.width/5, 20);
...
- (void)loadData {
    ...
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"on"]];
    _pageControl.pageIndicatorTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"off"]];
